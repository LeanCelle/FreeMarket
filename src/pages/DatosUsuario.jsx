    ...
    <div className="formulario">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="campo">
          ...
          <input type="text" id="piso" name="piso" value={formData.piso} onChange={handleChange}/>
        </div>
        <div className="campo">
        ...
        <div className="campo">
          ...
          <input type="email" id="confirmarMail" name="confirmarMail" value={formData.confirmarMail} onChange={handleChange} required/>
        </div>
        ...
        <input type="text" id="numeroTarjeta" name="numeroTarjeta" value={formData.numeroTarjeta} onChange={handleNumeroTarjetaChange} maxLength="19" required/>
      </div>
        <div className="campo">
            <label htmlFor="fechaVencimiento">Fecha de Vencimiento*</label>
            <DatePicker selected={formData.fechaVencimiento} onChange={handleFechaVencimientoChange} dateFormat="MM/yyyy" showMonthYearPicker required/>
        </div>
        <div className="campo">
            <label htmlFor="cvv">CVV*</label>
            <input type="text" id="cvv" name="cvv" value={formData.cvv} onChange={handleCVVChange} maxLength="3" inputMode="numeric" required/>
        </div>
