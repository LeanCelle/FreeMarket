...
const InicioSesion = () => {
  const { email, password, setEmail, setPassword } = useContext(GeneralContext);
  ...
  return (
    <div className="inicioSesion">
      ...
      <div className="error_message">{authError}</div>
      ...
      <div className="crearCuenta">
        <h6 className="noCuenta">No tenes cuenta?</h6>
        <Link to='/registrate'><p>Registrate</p></Link>
      </div>
    </form>
    </div>
  );
