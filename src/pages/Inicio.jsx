    ...
    <>
      ...
      <div className='formaDePago' ref={formaDePagoRef}>
        ...
        <div className="cuotas">
          <img className='tarjeta' src="https://http2.mlstatic.com/storage/homes-korriban/assets/images/payments/mercado-creditsv2.svg" alt="" />
      ...
      <div className="footer-top">
        <div className="footer-section about">
          <h3>Acerca de FreeMarket</h3>
          <p>FreeMarket es tu destino en línea para encontrar las mejores ofertas en una amplia variedad de productos, desde electrónica hasta moda y mucho más. Nuestra misión es brindar una experiencia de compra confiable y emocionante.</p>
        </div>
        <div className="footer-section contact">
          <h3>Contacto</h3>
          <p>Si tienes preguntas, comentarios o inquietudes, no dudes en contactarnos:</p>
          <p>Email: leangerman13@freemarket.com</p>
        </div>
      </div>
      <div className="footer-section social">
          <div className="cardFooter">
            <a href="https://www.instagram.com/leancelle/" target="_blank" className="socialContainer containerOne">
            ...
            <a href="https://twitter.com/leandro_celle" target="_blank" className="socialContainer containerTwo">
            ...
            <a href="https://www.linkedin.com/in/leandrocelle/" target="_blank" className="socialContainer containerThree">
            ...
            <a href="https://w.app/leancelle" target="_blank" className="socialContainer containerFour">
