...
const Carrito = () => {
  ...
  const handleRemoveFromCart = (productId) => {
    removeFromCart(productId, 1); // Elimino un producto del carrito
  };
  ...
  return (
    <nav className="navbar bg-body-tertiary navCarrito">
      <div className="container-fluid div-carrito">
        <button
          className="navbar-toggler button-carrito"
          type="button"
        ...
        >
          ...
          <span className="contadorCarrito">{quantity > 0 ? quantity : ''}</span>
        </button>
        <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div className="cartTotal">
              <h4 className='textTotal'>TOTAL:</h4>
              <h5 className='total'>${getTotal()}</h5>
          </div>
          <div>
          <button className="cta">
            <span className="span">FINALIZAR COMPRA</span>
